...
func (b Int8) String() string         { return fmt.Sprintf("NBT_Byte %d", b.Int8) }
...
func (s Int16) String() string         { return fmt.Sprintf("NBT_Short %d", s.Int16) }
...
func (i Int32) String() string         { return fmt.Sprintf("NBT_Int %d", i.Int32) }
...
func (l Int64) String() string         { return fmt.Sprintf("NBT_Long %d", l.Int64) }
